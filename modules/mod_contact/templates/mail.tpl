...
<tr>
	...
	<center>
		<img src="{XConfig::get("WEBSITE_LINK")}/images/cms/logo.png" alt="" />
	</center>

	<hr />

	<p>{$xLang->misc["intro"]|sprintf:XConfig::get("WEBSITE_LINK"):XConfig::get("WEBSITE_LINK")}</p>
	...
	<tr>
		...
		<td><font size="2">{XConfig::get("SESSION_LANGUAGE")}</font></td>
	</tr>
	<tr>
