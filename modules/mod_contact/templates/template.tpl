...
<div class="x-mod-contact{$xConf->css_name}">
	...
	<form action="{$location}" method="post" class="x-mod-contact-form">
		...
		<fieldset class="box-contact">
			...
			{html_options options=$xLang->options["titles"] id="x_title" name="x_title"}

			<br />

			<label for="x_name">{$xLang->labels["name"]}<b>*</b></label>
			<input type="text" id="x_name" name="x_name" maxlength="50" class="required" />

			<br />

			<label for="x_company">{$xLang->labels["company"]}</label>
			<input type="text" id="x_company" name="x_company" maxlength="50" />

			<br />

			<label for="x_email">{$xLang->labels["email"]}<b>*</b></label>
			<input type="text" id="x_mail" name="x_email" maxlength="50" class="required email" />

			<br />

			<label for="x_phone">{$xLang->labels["phone"]}</label>
			<input type="text" id="x_phone" name="x_phone" maxlength="25" class="phone" />

			<br />

			<label for="x_subject">{$xLang->labels["subject"]}<b>*</b></label>
			<input type="text" id="x_subject" name="x_subject" maxlength="50" class="required" />

			<br />

			<label for="x_message">{$xLang->labels["message"]}<b>*</b></label>
			<textarea id="x_message" name="x_message" class="required"></textarea>
