...
<div id='dvRequestPassword' style='display: none;' title="Request new password">
   ...
   <fieldset class='formBox'>
      ...
      <input type='text' name='request_name' id='request_name' title='{$xLang->messages['nameFail']}' required />

      <label for='request_mail'>{$xLang->labels['email']}</label>
      <input type='email' name='request_mail' id='request_mail' title='{$xLang->messages['mailFail']}' required />
