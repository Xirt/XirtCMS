...
<div class="x-content{$item->config->css_name}">
   ...
   <div class="box-options">
      ...
      <a href="{XConfig::get("SESSION_URL_BASE")}" title="{$xLang->buttons["back"]}" class="back" id="xBack">
      ...
      <a href="index.php?content=com_content&amp;task=show_print&amp;id={$item->xid}" title="{$xLang->buttons["print"]}" class="print" id="xPrint" rel="nofollow">
      ...
      <a href="index.php?content=com_helper&amp;task=no_javascript" title="{$xLang->buttons["mail"]}" class="mail" id="xMail" rel="nofollow">
   ...
   {if $item->config->mail_icon}
   <div id="xForward" style="display: none;">
      ...
      <fieldset class="box-form">
         ...
         <input type="text" name="x_rec_mail" value="" class="required email" maxlength="50" />
